...
C=====================================================================
C Subroutine to generate the MG5 param_card for use with the FeynRules
C UFO model: NLO EFT version
C=====================================================================

      SUBROUTINE WRITE_PARAM_CARD_EFT_NLO
      IMPLICIT NONE
C Common blocks:
      DOUBLE PRECISION MU2SQ,MU3SQ,LAMBDA1,LAMBDA2,LAMBDA3,LAMBDA4,
     .     LAMBDA5,M1,M2
...
c--End ADD
      ...
      WRITE(90,4)
      WRITE(90,6) "Block yukawa                    "
c      WRITE(90,7) 1, MDPOLE, "ymdo          "
c      WRITE(90,7) 2, MUPOLE, "ymup          "
c      WRITE(90,7) 3, MS,     "yms           "
c      WRITE(90,7) 4, MCPOLE, "ymc           "
      WRITE(90,7) 5, MBPOLE, "ymb           "
      WRITE(90,7) 6, MTPOLE, "ymt           "
c      WRITE(90,7) 11, MELEC, "yme           "
c      WRITE(90,7) 13, MMU,   "ymm           "
      WRITE(90,7) 15, MTAU,  "ymtau         "
      WRITE(90,*)
